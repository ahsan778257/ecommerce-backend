...
@section('body')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-10">
                {{ Form::open([ 'route'=>'customer-registration-save', 'method'=>'POST']) }}
                @csrf
                ...
                <div class="bg-light p-30 mb-5">
                    ...
                    <div class="col-md-6">
                        <h5>Already registred?<a  href="#cart-loginform" data-bs-target="#cart-loginform" data-bs-toggle="modal" class="text-black">Login</a> </h5>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="modal fade" id="cart-loginform">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content bg-info">
                            ...
                            {{ Form::open([ 'route'=>'cart.customer.login', 'method'=>'POST']) }}
